...
def print_list_with_argument(L):
    """ This function prints a list given as an argument. """
    return L


def print_list_without_argument():
    """ This function prints the list containing 1, 2, 3 and doesn't have any parameter."""
    L = [1, 2, 3]
    return L


def print_element_of_list(L):
    """ Given a list in argument, this function prints every element of that list. """
...
def max_list(L):
    """ Given a list as an argument, this function return the maximum element in the list. """
    max = L[0]
...
def nb_occurences(L, element):
    """ Given a list and an element as arguments; this function returns
